...
def main():
    ...
    if st.session_state.submitted:
        ...
        st.write("Your Request Has Been Received. Contact this number: xxxxx or this email: xx for further information.")
        if st.button("Submit another request"):
            st.session_state.submitted = False

    elif st.session_state.contact_submitted:
        st.success("Your contact request has been submitted successfully!")
        st.write("Your Contact Request Has Been Received. Contact this number: xxxxx or this email: xx for further information.")
        if st.button("Submit another contact request"):
            st.session_state.contact_submitted = False
